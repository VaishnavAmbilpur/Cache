...
const NavBarMobile = (props: NavBarProps) => {
  ...
  return (
    <>
        {props.hidden && (
          <div className='min-h-[950px] max-w-fit flex flex-col p-3 border-2 items-center  text-flush-orange-950'>
    ...
    <div className="flex flex-row items-center gap-3 m-3">
      <Link
        to="/"
        className="hover:bg-flush-orange-100 hover:text-flush-orange-900 rounded-lg p-2 transition-all duration-300 delay-75 hover:translate-y-1 hover:scale-100"
      >
        <FaHouse size={21} />
      </Link>
    </div>
